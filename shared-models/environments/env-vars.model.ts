...
export enum ProductionCloudStorage {
  ...
  EXPN_ADMIN_REPORTS_STORAGE_AF_CF = 'explearning-admin-reports',
  EXPN_ADMIN_REPORTS_STORAGE_FB = 'gs://explearning-admin-reports',
  ...
  MDLS_ADMIN_REPORTS_STORAGE_AF_CF = 'marydaphne-admin-reports',
  MDLS_ADMIN_REPORTS_STORAGE_FB = 'gs://marydaphne-admin-reports',
  ...
  SYW_ADMIN_REPORTS_STORAGE_AF_CF = 'syw-admin-reports',
  SYW_ADMIN_REPORTS_STORAGE_FB = 'gs://syw-admin-reports',
  ...
  ADVE_ADMIN_REPORTS_STORAGE_AF_CF = 'adve-admin-reports',
  ADVE_ADMIN_REPORTS_STORAGE_FB = 'gs://adve-admin-reports',
}
...
export enum SandboxCloudStorage {
  ...
  EXPN_ADMIN_REPORTS_STORAGE_AF_CF = 'explearning-sandbox-admin-reports',
  EXPN_ADMIN_REPORTS_STORAGE_FB = 'gs://explearning-sandbox-admin-reports',
  ...
  MDLS_ADMIN_REPORTS_STORAGE_AF_CF = 'marydaphne-sandbox-admin-reports',
  MDLS_ADMIN_REPORTS_STORAGE_FB = 'gs://marydaphne-sandbox-admin-reports',
  ...
  SYW_ADMIN_REPORTS_STORAGE_AF_CF = 'syw-sandbox-admin-reports',
  SYW_ADMIN_REPORTS_STORAGE_FB = 'gs://syw-sandbox-admin-reports',
  ...
  ADVE_ADMIN_REPORTS_STORAGE_AF_CF = 'adve-sandbox-admin-reports',
  ADVE_ADMIN_REPORTS_STORAGE_FB = 'gs://adve-sandbox-admin-reports',
}
