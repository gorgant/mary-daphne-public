...
export const metaTagsContentPages = {
  explearningPublic: {
    ...
    // tslint:disable-next-line: max-line-length
    blogMetaDescription: `On Explearning's blog you have access to our complete library of free lessons on speaking skills and effective communication. From public speaking techniques to interview strategies and negotiation tactics, our goal is to make you the best communicator you can be.`,
    blogPageTitle: 'Explearning Blog',
    ...
    homeCapIconOnePath: 'assets/icons/confidence_fist_icon',
    ...
    homeCapIconTwoPath: 'assets/icons/authenticity_icon',
    ...
    homeCapIconThreePath: 'assets/icons/poise_icon',
    ...
    // tslint:disable-next-line: max-line-length
    podcastSoundCloudUrl: 'https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/users/672246926&color=%23ff5500&auto_play=false&hide_related=false&show_comments=false&show_user=false&show_reposts=false&show_teaser=true',
    podcastMetaTitle: `Podcast - ${metaTagDefaults.explearningPublic.metaTagSiteName}`,
    // tslint:disable-next-line: max-line-length
    podcastMetaDescription: `Get our lastest communications strategies in audio form from our weekly Explearning podcast. Available on all the major directories, including Soundlcoud, iTunes, Google Podcast, Spotify, and more.`,
    ...
    // tslint:disable-next-line: max-line-length
    webcourseListMetaDescription: `${metaTagDefaults.explearningPublic.metaTagSiteName} offers interactive, in-depth web courses that are designed to take your communication skills and social skills to new level.`,
